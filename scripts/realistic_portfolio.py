...
def main():
    ...
    print("    Stop Loss:     3x ATR (disaster protection only)")
    print("    Take Profit:   None (strategy signal handles exits)")
    print("    Trailing Stop: None")
    print("    Breakeven:     None")
    print("")
    print("  Expected Performance (most realistic estimate):")
    ...
    print("    Max loss per SL hit: ~4-5% (3x ATR)")
    print("    SL trigger rate: ~2-4% of trades")
    print("    Protection against: exchange outages, flash crashes,")
    print("                        black swans, bot disconnection")
